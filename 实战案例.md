...
* CUDA与CUDNN的关系：CUDA是一个工作台，cuDNN是基于CUDA的深度学习GPU加速库，有了它才能在GPU上完成深度学习的计算。要了解操作系统、NVIDIA CUDA、CUDA驱动程序以及NVIDIA cuDNN 8.3.1的支持信息，请查看支持矩阵https://docs.nvidia.com/deeplearning/cudnn/archives/cudnn-831/support-matrix/index.html，安装cuDNN的信息，请查看NVIDA官网
...
* 了解半监督学习的算法
## 学习参考
Anaconda 2011 window version 安装参考文件修改为 https://github.com/bettermorn/IAICourse/blob/main/Code/Ex04/requirements.txt
