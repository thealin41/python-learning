...
* 代码需要调整的地方,参考 https://stackoverflow.com/questions/64772335/pytorch-w-parallelnative-cpp206
> * 调整 num_workers = 0 否则会出现 AssertionError: can only test a child process
> * 初始化模型之前增加以下代码，以消除以下警告
