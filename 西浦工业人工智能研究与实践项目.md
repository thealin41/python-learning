...
## report and poster
报告为详细内容，poster用于汇报展示。以下为撰写注意事项。
* 用表格和图描述实验流程和结果。
* 增加必要的文献来源。
### 报告内容
...
> * 代码结构、部署和运行方式
### Poster
Poster展示项目的主要内容，用于汇报，可参考模板 https://github.com/bettermorn/IAICourse/tree/main/refermaterials/templates，详细信息科参考https://www.posterpresentations.com/free-poster-templates.html
### 创新方案的描述
